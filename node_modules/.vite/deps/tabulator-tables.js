...
function xlsx(list2, options, setFileContents) {
  var self = this, sheetName = options.sheetName || "Sheet1", workbook = XLSX.utils.book_new(), tableFeatures = new CoreFeature(this), output;
  workbook.SheetNames = [];
  workbook.Sheets = {};
...
var ResizeColumns = class extends Module {
  ...
  initializeColumn(type, component, column, element) {
    ...
    if ((mode === true || mode == type) && this._checkResizability(nearestColumn)) {
      ...
      if (column.modules.frozen) {
        handle2.style.position = "absolute";
        handle2.style.left = column.modules.frozen.marginValue + column.getWidth() + "px";
      }
...
var ResponsiveLayout = class extends Module {
  ...
  generateCollapsedContent() {
    var self = this, rows2 = this.table.rowManager.getDisplayRows();
    rows2.forEach(function(row) {
    ...
    switch (typeof rows2) {
      ...
      case "string":
        ...
        if (rowMatch) {
          ...
          this.table.rowManager.getRows(rows2).forEach((row) => {
            this._selectRow(row, true, true);
          });
        }
        this._rowSelectionChanged();
