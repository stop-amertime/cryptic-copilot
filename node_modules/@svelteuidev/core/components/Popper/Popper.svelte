...
export let use = [], element = undefined, className = '', override = {}, position = 'top', placement = 'center', gutter = 5, arrowSize = 3, arrowDistance = 3, arrowClassName = 'arrow', withArrow = false, zIndex = 1, transition = fade, transitionDuration = 100, exitTransition = transition, exitTransitionDuration = transitionDuration, mounted = false, reference = null;
