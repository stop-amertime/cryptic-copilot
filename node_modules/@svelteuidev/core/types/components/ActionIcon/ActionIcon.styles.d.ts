...
declare const _default: (params?: ActionIconStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"variants" | "root">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"variants" | "root", string>;
