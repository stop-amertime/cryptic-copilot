...
declare const _default: (params?: AlertStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"content" | "icon" | "variants" | "root" | "title" | "label" | "message" | "wrapper" | "closeButton">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"content" | "icon" | "variants" | "root" | "title" | "label" | "message" | "wrapper" | "closeButton", string>;
