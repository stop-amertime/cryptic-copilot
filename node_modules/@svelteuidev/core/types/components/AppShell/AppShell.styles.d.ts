...
declare const _default: (params?: AppShellStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"body" | "root" | "main">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"body" | "root" | "main", string>;
