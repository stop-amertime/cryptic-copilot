...
export type { AppShellProps } from './AppShell.styles';
...
export type { HorizontalSectionSharedProps, HorizontalSectionProps } from './HorizontalSection/HorizontalSection.styles';
export type { VerticalSectionSharedProps, VerticalSectionProps } from './VerticalSection/VerticalSection.styles';
