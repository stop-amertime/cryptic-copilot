import type { DefaultProps, SvelteUIColor, SvelteUIGradient, SvelteUINumberSize, SvelteUISize, VariantThemeFunction } from '../../styles';
...
export declare function getVariantStyles(color: SvelteUIColor, variant: BadgeVariant, size: number | string, gradient: SvelteUIGradient): VariantThemeFunction;
/**
 ...
 */
export declare const getVariant: (color: SvelteUIColor, gradient?: SvelteUIGradient) => VariantThemeFunction;
...
declare const _default: (params?: BadgeStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"variants" | "root" | "leftSection" | "rightSection" | "inner">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"variants" | "root" | "leftSection" | "rightSection" | "inner", string>;
