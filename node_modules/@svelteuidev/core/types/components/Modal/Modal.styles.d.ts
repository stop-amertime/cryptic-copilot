...
declare const _default: (params?: ModalStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"close" | "overlay" | "body" | "root" | "title" | "header" | "inner" | "modal">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"close" | "overlay" | "body" | "root" | "title" | "header" | "inner" | "modal", string>;
