...
class CompletionsProviderImpl {
    ...
    async resolveCompletion(document, completionItem, cancellationToken) {
        ...
        if ((0, path_1.basename)(filePath).startsWith('+') && ((_b = comp.source) === null || _b === void 0 ? void 0 : _b.includes('.svelte-kit/types'))) {
            // resolve path from filePath to svelte-kit/types
            // src/routes/foo/+page.svelte -> .svelte-kit/types/foo/$types.d.ts
            const routesFolder = ((_e = (_d = (_c = document.config) === null || _c === void 0 ? void 0 : _c.kit) === null || _d === void 0 ? void 0 : _d.files) === null || _e === void 0 ? void 0 : _e.routes) || 'src/routes';
            const relativeFilePath = (_f = filePath.split(routesFolder)[1]) === null || _f === void 0 ? void 0 : _f.slice(1);
            if (relativeFilePath) {
                is$typeImport = true;
                comp.source =
                    comp.source.split('.svelte-kit/types')[0] +
                        // note the missing .d.ts at the end - TS wants it that way for some reason
                        `.svelte-kit/types/${routesFolder}/${(0, path_1.dirname)(relativeFilePath)}/$types`;
                comp.data = undefined;
            }
        }
        const getDetail = () => lang.getCompletionEntryDetails(filePath, tsDoc.offsetAt(tsDoc.getGeneratedPosition(comp.position)), comp.name, {}, comp.source, errorPreventingUserPreferences, comp.data);
        ...
        if (actions) {
            ...
            completionItem.additionalTextEdits = ((_g = completionItem.additionalTextEdits) !== null && _g !== void 0 ? _g : []).concat(edit);
        }
        return completionItem;
    }
