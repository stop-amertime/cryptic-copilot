<script lang="ts">
	import Substitution from "./Substitution.svelte";
	...
	import Anagram from "./Anagram.svelte";
	import Container from "./Container.svelte";
	import { Wave } from "svelte-loading-spinners";
	import { fade } from "svelte/transition";
	import { writable } from "svelte/store";
	import HiddenWord from "./HiddenWord.svelte";
	import SoundsLike from "./SoundsLike.svelte";
	/* -------------------------------------------------------------------------- */
